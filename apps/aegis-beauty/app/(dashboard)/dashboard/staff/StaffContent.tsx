      ...
      {deleteConfirm && createPortal(
        <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4">
          ...
          >
            ...
            <h3 className="text-base font-semibold text-gray-900 mb-1.5">Elimina membro</h3>
            <p className="text-sm text-gray-500 mb-6">
              Sei sicuro di voler eliminare <span className="font-semibold text-gray-800">{deleteConfirm.full_name}</span>? Questa azione non può essere annullata.
            </p>
