          ...
          {loading ? (
            ...
            <div className="space-y-5">
              ...
              <div className="space-y-2">
                ...
                />
                <div className="text-right text-xs mt-1" style={{ color: notes.length >= 1000 ? '#ef4444' : '#9ca3af' }}>
                  {notes.length}/1000
                </div>
              ...
              <div className="space-y-2">
                ...
                />
                <div className="text-right text-xs mt-1" style={{ color: preferences.length >= 500 ? '#ef4444' : '#9ca3af' }}>
